<div class="min-h-screen">
    ...
    <div class="flex justify-center my-4 mx-2">
        ...
        <button href='{{ route('create-users') }}' wire:navigate
            ...
            <div class="p-4 w-full sm:w-1/3 lg:w-1/6">
                <div class="bg-[#D4EAE6] p-6 rounded-md h-full">
                    ...
                    <div class="flex justify-center mt-4">
                        <button
                            class="bg-[#39A0FF] hover:bg-[#1991ff] text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline">Info</button>
                    </div>
                    <div class="flex justify-center mt-4">
                        <button href="{{ route('update-users', $user->id) }}" wire:navigate
                            class="bg-[#1BC300] hover:bg-[#18af00] text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline">Update</button>
